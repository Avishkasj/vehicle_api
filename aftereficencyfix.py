...
def scrape():
    try:
        ...
        for item in items:
            ...
            ad_info['title'] = title_element.a['title'] if title_element else "Title Not Available"
            ad_info['link'] = title_element.a['href'] if title_element else "Link Not Available"

            # Extract date and time information
            date_time_element = item.find('h2', style="font-size:13px;text-align:center;color:#636b75;font-weight:normal;padding:0 0 5px 0;line-height:1.3em;")
            ad_info['date_time'] = date_time_element.text.strip() if date_time_element else "Date and Time Not Available"
            ...
            ad_info['image_url'] = "https:" + image_element['src'] if image_element else "Image Not Available"

            # Include source data
            ad_info['source'] = 'riyasewana'
